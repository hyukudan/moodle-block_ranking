...
$string['notification_daily_subject'] = '{$a->firstname}, daily ranking update in {$a->coursename}';
$string['notification_daily_greeting'] = 'Hi {$a->firstname}, here is your ranking update for {$a->coursename}.';
$string['notification_daily_gained_one'] = 'You have moved up 1 position.';
$string['notification_daily_gained_many'] = 'You have moved up {$a} positions.';
$string['notification_daily_lost_one'] = 'You have moved down 1 position.';
$string['notification_daily_lost_many'] = 'You have moved down {$a} positions.';
$string['notification_daily_enteredtop3'] = 'You have entered the TOP 3.';
$string['notification_daily_lefttop3'] = 'You have left the TOP 3.';
$string['notification_daily_status'] = 'Current position: {$a->position}. Points: {$a->points}.';
$string['notification_daily_link'] = 'View the full ranking: {$a}';
$string['notification_daily_smallmessage'] = 'Daily ranking update: {$a}';

// Scheduled tasks.
$string['task_daily_ranking_digest'] = 'Send daily ranking digests';
...
$string['privacy:metadata:block_ranking_daily_state'] = 'Stores daily ranking digest state per user and course.';
$string['privacy:metadata:block_ranking_daily_state:userid'] = 'The ID of the user.';
$string['privacy:metadata:block_ranking_daily_state:courseid'] = 'The ID of the course.';
$string['privacy:metadata:block_ranking_daily_state:localdate'] = 'The site-local date for the digest state.';
$string['privacy:metadata:block_ranking_daily_state:startposition'] = 'The ranking position at the first daily mark.';
$string['privacy:metadata:block_ranking_daily_state:startpoints'] = 'The ranking points at the first daily mark.';
$string['privacy:metadata:block_ranking_daily_state:endposition'] = 'The ranking position at the end of the local day.';
$string['privacy:metadata:block_ranking_daily_state:endpoints'] = 'The ranking points at the end of the local day.';
$string['privacy:metadata:block_ranking_daily_state:enteredtop3'] = 'Whether the user entered the top 3 during the day.';
$string['privacy:metadata:block_ranking_daily_state:lefttop3'] = 'Whether the user left the top 3 during the day.';
$string['privacy:metadata:block_ranking_daily_state:wasovertaken'] = 'Whether the user lost ranking positions during the day.';
$string['privacy:metadata:block_ranking_daily_state:positionslost'] = 'The number of ranking positions lost during the day.';
$string['privacy:metadata:block_ranking_daily_state:positionsgained'] = 'The number of ranking positions gained during the day.';
$string['privacy:metadata:block_ranking_daily_state:sent'] = 'Whether the daily digest state has been handled.';
$string['privacy:metadata:block_ranking_daily_state:timesent'] = 'The time the daily digest state was handled.';
$string['privacy:metadata:block_ranking_daily_state:timecreated'] = 'The time the daily digest state was created.';
$string['privacy:metadata:block_ranking_daily_state:timemodified'] = 'The time the daily digest state was last modified.';
